...
pub fn run() {
    let result = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ipc::repo_view::repo_changes,
            ipc::repo_view::repo_file_versions,
            ipc::repo_view::worktree_add,
            ipc::repo_view::worktree_remove,
            ipc::repo_view::open_in_finder,
            ipc::repo_view::open_in_vscode,
            ipc::repo_view::repo_abs_path,
            ipc::repo_view::git_branches,
            ipc::repo_view::git_create_branch,
            ipc::repo_view::git_delete_branch,
            ipc::repo_view::git_checkout,
            ipc::repo_view::git_commit,
