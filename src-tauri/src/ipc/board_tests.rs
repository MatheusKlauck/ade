// Tests for board.rs — moved out of the inline `mod tests` to keep the
// production file readable. Still `crate::...::board::tests` via #[path],
// so `super::*` resolves to the parent module's items unchanged (#22).
use super::*;
use crate::board_pos::{insert_between, needs_rebalance, rebalance};
